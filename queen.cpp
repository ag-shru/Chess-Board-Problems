// Solving N- Queens and N-Rooks Problem #include #include

using namespace std;

class NQueensNRooks { public: // Constructor initializes the board and sets the number of solutions to zero NQueensNRooks(int n) : N(n), board(n, vector(n, '.')), solutionsQueens(0), solutionsRooks(0) {}
...
private: int N; // Size of the board (N x N) int solutionsQueens; // Counter for the number of solutions for queens int solutionsRooks; // Counter for the number of solutions for rooks vector<vector> board; // 2D vector representing the chessboard
